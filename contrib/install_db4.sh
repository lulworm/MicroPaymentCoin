...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the micropaymentcoin repository."
  exit 1
fi
...
echo
echo 'When compiling micropaymentcoind, run `./configure` in the following way:'
echo
