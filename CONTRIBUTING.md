Contributing to MicroPaymentCoin Core
============================

The MicroPaymentCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/micropaymentcoin-project/micropaymentcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MicroPaymentCoin Core project, and is not to be
confused with overall MicroPaymentCoin Network Protocol consensus changes.

Whether a pull request is merged into MicroPaymentCoin Core rests with the project merge
...
Patches that change MicroPaymentCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the MicroPaymentCoin consensus, it must have been
...
The project leader is the release manager for each MicroPaymentCoin Core release.
