...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MicroPaymentCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MicroPaymentCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MicroPaymentCoin features */
        {"micropaymentcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"micropaymentcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"micropaymentcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"micropaymentcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"micropaymentcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"micropaymentcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"micropaymentcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"micropaymentcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"micropaymentcoin", "startmasternode", &startmasternode, true, true, false},
        {"micropaymentcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"micropaymentcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"micropaymentcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"micropaymentcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"micropaymentcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"micropaymentcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"micropaymentcoin", "preparebudget", &preparebudget, true, true, false},
        {"micropaymentcoin", "submitbudget", &submitbudget, true, true, false},
        {"micropaymentcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"micropaymentcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"micropaymentcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"micropaymentcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"micropaymentcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"micropaymentcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"micropaymentcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"micropaymentcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"micropaymentcoin", "mnsync", &mnsync, true, true, false},
        {"micropaymentcoin", "spork", &spork, true, true, false},
        {"micropaymentcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmpcseed", &getzmpcseed, false, false, true},
        {"zerocoin", "setzmpcseed", &setzmpcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmpc", &searchdzmpc, false, false, true},
        {"zerocoin", "dzmpcstate", &dzmpcstate, false, false, true},
...
{
    return "> micropaymentcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15765/\n";
}
