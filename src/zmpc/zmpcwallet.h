...
#ifndef MicroPaymentCoin_ZMPCWALLET_H
#define MicroPaymentCoin_ZMPCWALLET_H
...
public:
    CzMPCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMPC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMPC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //MicroPaymentCoin_ZMPCWALLET_H
