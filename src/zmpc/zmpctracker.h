...
#ifndef MicroPaymentCoin_ZMPCTRACKER_H
#define MicroPaymentCoin_ZMPCTRACKER_H
...
public:
    CzMPCTracker(std::string strWalletFile);
    ~CzMPCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMPCWallet* zMPCWallet = NULL);
...
#endif //MicroPaymentCoin_ZMPCTRACKER_H
