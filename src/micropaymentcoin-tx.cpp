...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MicroPaymentCoin Core micropaymentcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  micropaymentcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded micropaymentcoin transaction") + "\n" +
                               "  micropaymentcoin-tx [options] -create [commands]   " + _("Create hex-encoded micropaymentcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded micropaymentcoin transaction
