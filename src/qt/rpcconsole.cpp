                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMPCPathCustom = GetArg("-zmpcbackuppath", "");
    ...
    if(!strzMPCPathCustom.empty()) {
        ui->wallet_customzmpcbackuppath->setText(QString::fromStdString(strzMPCPathCustom));
        ui->wallet_customzmpcbackuppath_label->setVisible(true);
        ui->wallet_customzmpcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMPCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MicroPaymentCoin RPC console.") + "<br>" +
