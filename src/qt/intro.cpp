...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MicroPaymentCoin Core"),
     ...
     * override -datadir in the micropaymentcoin.conf file in the default data directory
     * (to be consistent with micropaymentcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
