...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::MPC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeMicroPaymentCoinAmount"))
        SoftSetArg("-anonymizemicropaymentcoinamount", settings.value("nAnonymizeMicroPaymentCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in micropaymentcoin.cpp during shotdown to also remove the window positions
