...
/** Utility functions used by the MicroPaymentCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MicroPaymentCoin addresses in monospace font
...
// Parse "micropaymentcoin:" URI into recipient object, return true on successful parsing
